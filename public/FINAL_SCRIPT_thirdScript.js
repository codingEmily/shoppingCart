...
fetch('/popup.html?version=' + Date.now()) 
  ...
  .then(html => {
    ...
    cartIcon = document.querySelector('#shoppingCartIcon');
    cartCountIndicator = document.querySelector('#cartCountIndicator');
    popupContent = document.querySelector('#popupContent');
    entireBtnAndPopup = document.querySelector('#entireBtnAndPopup');
    cartTotalDisplay = document.querySelector('.cartTotal')
